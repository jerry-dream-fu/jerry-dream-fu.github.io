...
def get_info_fiveonekaoyan(url):
    ...
    headers = {
    "cookie": "1267901=9250673d540e9747e2560b198f794860; website_user_user_new=20220218; PHPSESSID=k31p2u7dl7jq4quvucn7ad1nr1; Hm_lvt_ee072f8f511a16fc6995d74eb3e07a3b=1645150366; SiteStatsSignKey=d8869f1440417d1765b3f341530c48cb; qx_trespass=https%3A%2F%2Fwww.51kywang.com%2F51kaoyanwang%2Fvip_doc%2F25221089_0_0_1.html; acw_tc=3adad03b16455076406354501ed9dc84c6a092e13d29024f8f9da9db1f; Hm_lpvt_ee072f8f511a16fc6995d74eb3e07a3b=1645508663",
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36'}
    req=urllib.request.Request(url,headers=headers)
    print("link: "+url)
    res=urlopen(req)
